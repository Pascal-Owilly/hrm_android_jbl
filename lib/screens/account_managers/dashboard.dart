...
class _DashboardPageState extends State<DashboardPage> {
            ...
            onPressed: () {
              showDialog(
                ...
                builder: (BuildContext context) {
                  return AlertDialog(
                    title: Text('Clock-In Information'),
                    content: Text(
                      'For more details on your employees\' clock-ins, please refer to the web application.',
                    ),
                    actions: <Widget>[
                      TextButton(
                        child: Text('OK'),
                      ...
                      TextButton(
                        ...
                        onPressed: () {
                          ...
                          launchUrl('https://www.jawabubest-wms.com/dashboard/account-manager');
                        },
                      ),
                    ],
                  );
  ...
  Widget _buildAttendanceTable() {
    ...
    // Filter clockIns based on user ID
...
void launchUrl(String url) async {
  // Ensure you have the url_launcher package added to your pubspec.yaml
  // Add `url_launcher` to dependencies if not already added
